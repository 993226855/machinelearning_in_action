...
# define a struct just for storing variables and data[仅仅用于存储变量和数据]
class SVMStruct:
...
def innerLoop(svm, alpha_i):
    ...
    # 2) yi*f(i) == 1 and 0< C (on the boundary)
...
dataSet = []
labels = []
fileIn = open('E:/Python-Workspace/machinelearning/7_svm/data/testSet.txt')
